...
- 小插曲
  ...
  - 我在这里定义了一个链接，点击访问ZK元数据，但地址发生变化，内容却没有~待解决！目前认为可以通过路由解决~

  ![](IMG/微信截图_20201215222503.png)
...
- 还有一个，今天前端打包后，使用后端打开，有个小问题，就是侧边栏样式设置无效~
  - 解决了，在这个地方添加内容，重新打包即可

![](IMG/微信截图_20201215225427.png)
